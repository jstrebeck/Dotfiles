...
#Install apt
apt_deps=(stow zsh gnustep-gui-runtime ripgrep neovim copyq sway swaylock waybar rofi alacritty build-essential curl gnupg software-properties-common ca-certificates gnome-tweaks wl-clipboard btop brightnessctl python3-mako terraform-ls)
